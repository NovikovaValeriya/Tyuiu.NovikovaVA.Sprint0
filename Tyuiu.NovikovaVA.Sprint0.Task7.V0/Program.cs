using Tyuiu.NovikovaVA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.NovikovaVA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Ошибка! Исходные массива имеют разное количество элементов");
            }
            Console.ReadKey();
